...
<div class="container" align="center" >
  ...
  <div class="video container">
    ...
    <source src="media/camille.mp4" type="video/mp4">
    <source src="media/camille.webm" type="video.webm">
    </video>
  </div>
  </div>
  ...
  <div class="container">
    <div class> <img class="responsive-img" src="assets/camilleBackground.jpg" align="left"/></div>
    <div class="responsive-text align center"> <p> <u> <h4> Playing Camille </h4> </u> Camille is a strong top lane pick, with a great kit that can turn around games. Also, her range of combos and the Hookshot makes her great at controlling the game. Overall, she's a great pick that is great at countering the current meta.
    Camille is efficient in small, short trades. Utilising her Hookshot (E) range, a simple and devastating combo is to proc the first part of her Precision Protocol (Q), then follow up with her hookshot into a quick auto attack followed by the enhanced Precision protocol, which will do increased damage with true damage, which can not be mitigated by armour. These trades allow Camille to wittle down her opponentsm till the point where she can execute them. </p> </div>
  </div>


  <!--carousel -->
  <div class="carousel">
    <a class="carousel-item" href="#one!"><img src="assets/cS1.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#two!"><img src="assets/cS2.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#three!"><img src="assets/cS3.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#four!"><img src="assets/cS4.jpg" height="200px" width="250px"></a>
