...
<div class="center amber-text darken-1">  <H2> Check out Zoe! </H2> </div>
</div>
<!-- embedded twitter video (not centralised)-->
<div class="container text-center">
  <blockquote class="twitter-tweet center" data-lang="en-gb"><p lang="en" dir="ltr">✨✨Zoe, the Aspect of Twilight✨✨ <br>Want to know more?<br>Check out her reveal page here!<br>---&gt; <a href="https://t.co/68e0AZYvDy">https://t.co/68e0AZYvDy</a> <a href="https://t.co/dBGQhWXS04">pic.twitter.com/dBGQhWXS04</a></p>&mdash; League of Legends (@LeagueOfLegends) <a href="https://twitter.com/LeagueOfLegends/status/927619918249340928?ref_src=twsrc%5Etfw">6 November 2017</a></blockquote>
...
<!-- header -->
<div class="section blue-grey darken-3">
<div class="center amber-text darken-1">  <H5> What do you guys think? </H5> </div>
</div>
   ...
   <form class="col s12">
     <div class="row">
       <div class="input-field col s12">
         <!-- modal -->
         <div class="right">
         <a class="waves-effect waves-light btn modal-trigger blue-grey darken-4" href="#modal4">Delete</a>
       </div>
         <!-- edit modal -->
         <div class="right">
         <a class="waves-effect waves-light btn modal-trigger blue-grey darken-4" href="#modal5">Edit</a>
       </div>
         <textarea id="textarea2" class="materialize-textarea"></textarea>
         <label for="textarea2">Comment</label>

          <!-- Delete modal button structure -->
          <div id="modal4" class="modal">
                  <div class="modal-footer">
                    <div class="center">
                    <button class="btn waves-effect waves-light blue-grey darken-4" type="submit" name="action">Cancel</button>
                      <button class="btn waves-effect waves-light blue-grey darken-4" type="submit" name="action" align="right">Delete Comment </button>
             </div>
           </div>
         </div>
         </div>
             ...
             <form class="col s12">
               <div class="row">
                 <div class="input-field col s12">
                     ...
                     <input id="icon_prefix" type="text" class="formtext validate">
                   <label for="textarea1">Edit your comment</label>
                   <div class="center">
                   <button class="btn waves-effect waves-light blue-grey darken-4" type="submit" name="action">Cancel</button>
                   <button class="btn waves-effect waves-light blue-grey darken-4" type="submit" name="action">Submit
