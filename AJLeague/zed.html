...
<div class="container" align="center" >
  ...
  <div class="video container">
    ...
    <source src="media/zed.mp4" type="video/mp4">
    <source src="media/zed.webm" type="video.webm">
    </video>
  </div>
  </div>

  <!-- Zed Background image and text-->
  <div class="container">
    <div class> <img class="responsive-img" src="assets/zedBackground.jpg" align="left"/></div>
    <div class="responsive-text align center"> <p> <u> <h4> Playing Zed </h4> </u>  Zed is a Mid Lane assassin in League of Legends. Zed is extremely good at taking one champion out of the fight, but then loses a lot of his power once Death Mark is on cooldown. Zed has a great laning phase in most matchups and can easily snowball in the early-game, making him a great champion to close out games early.
      Zed is able to poke effectively using his Living Shadow (W) which mimics his other abilities, such as his Razor Shuriken and Shadow Slash. A good harass combo is to start with Living Shadow into Shadow Slash, which will slow the enemy champion, allowing you to land your Razor Shurikens and proc the electrocute rune. combined with lethality items, Zed can dominate his lane phase.
 </p> </div>
  </div>
  ...
  <!--carousel -->
  <div class="carousel">
    <a class="carousel-item" href="#one!"><img src="assets/zS1.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#two!"><img src="assets/zS2.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#three!"><img src="assets/zS3.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#four!"><img src="assets/zS4.jpg" height="200px" width="250px"></a>
    <a class="carousel-item" href="#five!"><img src="assets/zS5.jpg" height="200px" width="250px"></a>
  </div>
